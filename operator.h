...
namespace ExprEval 
{
    namespace Operator
    {
        ...
        double _add(double* args, size_t count=2){ return args[0] + args[1]; }
        double _subtract(double* args, size_t count=2){ return args[0] - args[1]; }
        double _multiply(double* args, size_t count=2){ return args[0] * args[1]; }
        double _divide(double* args, size_t count=2){ return args[0] / args[1]; }
        double _pow(double* args, size_t count=2){ return pow(args[0], args[1]); }
        double _mod(double* args, size_t count=2) { return fmod(args[0], args[1]); }

        double _ln(double* args, size_t count=2){ return log(args[0]); }
        double _log2(double* args, size_t count=2){ return log2(args[0]); }
        double _log10(double* args, size_t count=2){ return log10(args[0]); }

        double _sin(double* args, size_t count=1){ return sin(args[0]); }
        double _cos(double* args, size_t count=1){ return cos(args[0]); }
        double _tan(double* args, size_t count=1){ return tan(args[0]); }
        double _cot(double* args, size_t count=1){ return cos(args[0])/sin(args[0]); }
        double _sinh(double* args, size_t count=1){ return sinh(args[0]); }
        double _cosh(double* args, size_t count=1){ return cosh(args[0]); }
        double _tanh(double* args, size_t count=1){ return tanh(args[0]); }
        // double _coth(double* args, size_t count=1){ return coth(args[0]); }
        double _arcsin(double* args, size_t count=1){ return asin(args[0]); }
        double _arccos(double* args, size_t count=1){ return acos(args[0]); }
        double _arctan(double* args, size_t count=1){ return atan(args[0]); }
        // double _arccot(double* args, size_t count=1){ return acot(args[0]); }
        double _arcsinh(double* args, size_t count=1){ return asinh(args[0]); }
        double _arccosh(double* args, size_t count=1){ return acosh(args[0]); }
        double _arctanh(double* args, size_t count=1){ return atanh(args[0]); }
        // double _arccoth(double* args, size_t count=1){ return asin(args[0]); }

        double _round(double* args, size_t count=1){ return round(args[0]); }
        double _floor(double* args, size_t count=1){ return floor(args[0]); }
        double _ceil(double* args, size_t count=1){ return ceil(args[0]); }
        double _abs(double* args, size_t count=1){ return fabs(args[0]); }
        double _gamma(double* args, size_t count=1){ return tgamma(args[0]); }
        double _rand(double* args, size_t count=1){ return (double)rand()/(double)RAND_MAX; }

        double _pi(double* args, size_t count=1){ return M_PI; }
        double _e(double* args, size_t count=1){ return M_E; }
